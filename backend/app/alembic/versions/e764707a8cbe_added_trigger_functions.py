...
Revision ID: e764707a8cbe
Revises: 80e9ca1cb85f
Create Date: 2025-03-21 16:39:40.808935
...
revision: str = "e764707a8cbe"
down_revision: Union[str, None] = "80e9ca1cb85f"
...
def upgrade() -> None:
    ...
    pass
    op.execute(PLPY_ENSURE)
    op.execute(FUNCTION_DELETER)
    op.execute(INSERT_TRIGGER_RULE)
    op.execute(RULES_TABLE_TRIGGER_FUNCTION)
    op.execute(RULES_TABLE_APPLY_TRIGGER)
...
PLPY_ENSURE = "CREATE EXTENSION IF NOT EXISTS plpython3u;"
